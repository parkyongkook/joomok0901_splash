...
import { StyleSheet, View, TouchableOpacity, Image, TextInput, CameraRoll, ScrollView, ActivityIndicator } from 'react-native';
import {
...
export default class SignUp_Information extends Component {
    ...
    constructor(props) {
        ...
        this.state = {
            ...
            //     birth: "19820523",
            //     password: "test1234",
            //     passConfirm: "test1234",
            //     email: "joomok@google.com",
            //     recommander: "없음",
            //     com_name: "주목",
            //     com_addr: "서울시 강남구 역삼동",
            //     com_addr1: "111-12",
            //     com_zipcode: "134024",
            //     com_phone: "025555555",
            //     com_serial: "1018617021",
            //     com_certify: "223112340",
            //     com_category: "20",
            //     isagree_rule: 1,
            //     isagree_info: 1
            // },
    ...
    adressSearch(address) {
        ...
        .then((response) => response.json())
        .then((adressDataList) => {
            adressDataList.code === "404" ? alert('올바른 주소가 아닙니다 다시확인해 주세요') : 
            this.setState({
            ...
            <Container style={{
                ...
                <Content style={{ backgroundColor: '#fff', }}>
                    ...
                    <View style={styles.SignUpFormParent}>
                        ...
                        <View style={{ flex: 3, flexDirection: "row", marginRight: 14, }}>

                            <View style={styles.birthDropBox}>
                                <Text style={{ fontSize: 14, flex: 3, textAlign: "center", color: "#70aed5", }}>{this.state.birthTab.year}</Text>
                                <ModalDropdown
                                    onSelect={
                                        (i, v) => this.onSelectBirth("year", i, v)
                                    }
                            ...
                            <View style={styles.birthDropBox}>
                                <Text style={{ fontSize: 14, flex: 3, textAlign: "center", color: "#70aed5", }}>{this.state.birthTab.month}</Text>
                                <ModalDropdown
                                    onSelect={
                                        (i, v) => this.onSelectBirth("month", i, v)
                                    }
                            ...
                            <View style={styles.birthDropBox}>
                                <Text style={{ fontSize: 14, flex: 3, textAlign: "center", color: "#70aed5", }}>{this.state.birthTab.day}</Text>
                                <ModalDropdown
                                    onSelect={
                                        (i, v) => this.onSelectBirth("day", i, v)
                                    }
                                    dropdownStyle={{ width: 85, marginLeft: -64, }}
                                    options={dayArr}
                                    style={{
